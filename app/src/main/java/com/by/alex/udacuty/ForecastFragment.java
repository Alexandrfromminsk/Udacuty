...
public class ForecastFragment extends Fragment {
    ...
    public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
        ...
        private String getReadableDateString(long time) {
            ...
            SimpleDateFormat shortenedDF = new SimpleDateFormat("EEE MMM dd");
            return shortenedDF.format(time);
        }
        ...
        private String[] getWeatherDataFromJson (String forecastJsonStr, int numDays)
            ...
            for (int i=0; i<weatherArray.length(); i++){
                ...
                JSONObject temeratureObject = dayForecast.getJSONObject(OWM_TEMPERATURE);
                double high = temeratureObject.getDouble(OWM_MAX);
                double low = temeratureObject.getDouble(OWM_MIN);
        ...
        protected String[] doInBackground(String... params) {
            ...
            try {
                ...
                Uri buildedUri = Uri.parse(FORECAST_BASE_URL).buildUpon()
